<template>
     <div v-if="props.editor" class="fixed-menu">
    <button :class="{ 'is-active': props.editor.isActive('bold') }" @click="props.editor.chain().focus().toggleBold().run()">
      Bold
    </button>
    <button @click="props.editor.chain().focus().toggleItalic().run()" :class="{ 'is-active': props.editor.isActive('italic') }">
      italic
    </button>
    <button @click="props.editor.chain().focus().toggleStrike().run()" :class="{ 'is-active': props.editor.isActive('strike') }">
      strike
    </button>
    <button @click="props.editor.chain().focus().toggleCode().run()" :class="{ 'is-active': props.editor.isActive('Code') }">
      Code
    </button>
    <button @click="
    ...
    <button @click="props.editor.chain().focus().toggleUnderline().run()"
      :class="{ 'is-active': props.editor.isActive('Underline') }">
      Underline
    </button>
    <button @click="setLink" :class="{ 'is-active': props.editor.isActive('link') }">
      setLink
    </button>
    <input type="color" @input="props.editor.chain().focus().setColor($event.target.value).run()"
      :value="props.editor.getAttributes('textStyle').color" />
    <button @click="props.editor.chain().focus().setColor('#958DF1').run()" :class="{
      'is-active': props.editor.isActive('textStyle', { color: '#958DF1' }),
    }">
      purple
    </button>
    <button @click="props.editor.chain().focus().setColor('#F98181').run()" :class="{
      'is-active': props.editor.isActive('textStyle', { color: '#F98181' }),
    }">
      red
    </button>
    <button @click="props.editor.chain().focus().setColor('#FBBC88').run()" :class="{
      'is-active': props.editor.isActive('textStyle', { color: '#FBBC88' }),
    }">
      orange
    </button>
    <button @click="props.editor.chain().focus().setColor('#FAF594').run()" :class="{
      'is-active': props.editor.isActive('textStyle', { color: '#FAF594' }),
    }">
      yellow
    </button>
    <button @click="props.editor.chain().focus().setColor('#70CFF8').run()" :class="{
      'is-active': props.editor.isActive('textStyle', { color: '#70CFF8' }),
    }">
      blue
    </button>
    <button @click="props.editor.chain().focus().setColor('#94FADB').run()" :class="{
      'is-active': props.editor.isActive('textStyle', { color: '#94FADB' }),
    }">
      teal
    </button>
    <button @click="props.editor.chain().focus().setColor('#B9F18D').run()" :class="{
    ...
    <button @click="props.editor.chain().focus().setTextAlign('left').run()"
      :class="{ 'is-active': props.editor.isActive({ textAlign: 'left' }) }">
      left
    </button>
    <button @click="props.editor.chain().focus().setTextAlign('center').run()"
      :class="{ 'is-active': props.editor.isActive({ textAlign: 'center' }) }">
      center
    </button>
    <button @click="props.editor.chain().focus().setTextAlign('right').run()"
      :class="{ 'is-active': props.editor.isActive({ textAlign: 'right' }) }">
      right
    </button>
    <button @click="props.editor.chain().focus().setTextAlign('justify').run()"
    ...
    <button @click="props.editor.chain().focus().toggleHeading({ level: 1 }).run()"
      :class="{ 'is-active': props.editor.isActive('heading', { level: 1 }) }">
      H1
    </button>
    <button @click="props.editor.chain().focus().toggleHeading({ level: 2 }).run()"
      :class="{ 'is-active': props.editor.isActive('heading', { level: 2 }) }">
      H2
    </button>
    <button @click="props.editor.chain().focus().toggleHeading({ level: 3 }).run()"
      :class="{ 'is-active': props.editor.isActive('heading', { level: 3 }) }">
      H3
    </button>
    <button @click="props.editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()">
      insertTable
    </button>
    ...
    <button @click="props.editor.chain().focus().setCellAttribute('colspan', 2).run()">
      setCellAttribute
    </button>
